    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Data DATA DIRI</h6>
                <a href="{{route('datadiriCreate')}}" class="btn btn-primary btn-sm mt-2">Tambah Data</a>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($items as $i)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('datadiriShow', $i->id)}}" class="btn btn-info btn-sm">Detail</a>
