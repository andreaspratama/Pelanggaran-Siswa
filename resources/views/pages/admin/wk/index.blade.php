    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="{{route('wk.create')}}" class="btn btn-primary btn-sm mt-2">Tambah Data</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($items as $i)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('wk.edit', $i->id)}}" class="btn btn-warning btn-sm">Edit</a>
                                        <form action="{{route('wk.destroy', $i->id)}}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
